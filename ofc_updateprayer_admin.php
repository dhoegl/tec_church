...
/* Process Prayer Request Update - Prayer Admin: Called from tecprayeradmin.php */
...
include_once('/includes/ofc_updateprayernotify_admin.php');
...
ofc_updateprayernotify_admin($prayer_ID, $prayer_name, $prayer_answered, $prayer_title, $update_text);

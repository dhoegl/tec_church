...
include('/includes/ofc_mail_out.php');
...
if(isset($_POST[requestorID])){
	...
	$prayer_email_from = $_POST['email_address'];
	...
	else
    {
		if($prayer_visible == '3') //All Church
        {
			...
			$praymaillink = $_POST['Domain_Name'];
			...
			$praymailmessage = "Hello! " . "<br />";
            if($prayer_onbehalfof){
                $praymailmessage .= "An OurFamilyConnections administrator, on behalf of <strong>" . $prayer_name . "</strong> has requested approval ";
            }
            else {
                $praymailmessage .= "<strong>" . $prayer_name . "</strong> has requested approval ";
            }
            $praymailmessage .= "to post a prayer request.<br /><br />Login to our site using your admin credentials, select the " . "<strong>Prayer Admin</strong>" . " menu item, and accept or reject their prayer request. <br />Details are below...<br />" . $praymaillink . "<br /><br /><strong>TITLE: </strong> " . $prayer_title . "<br /><br /><strong>REQUEST: </strong>" . $prayer_text . "." . "<br /><br />To send an email directly, use the following address:<br /><br />" . $prayer_email_from;
			...
			if($prayer_email_from) { // If new prayer request is created by Admin, do not send an email to requester
				...
				$praymailheaders .= "MIME-Version: 1.0\r\n";
				$praymailheaders .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
				mail_out($prayer_page_source,$prayer_owner,$praymailto,$praymailsubject,$praymailmessage,$praymailheaders);
			}
        ...
        else
        {
            if($prayer_visible == '1') //Elders Only
            {
                ...
                $elderpraylink = $_POST['Domain_Name'];

...
echo "<td width='294'><input name='myusername' type='text' id='myusername'></td> 		</tr>";
...
echo "<tr><td style='text-align:center;'><h1>Registration</h1></td></tr>";
echo "<tr><td style='text-align:center;'><h2><a href='ofc_profilesetup.php'>Existing TEC family</a></h2></td></tr>";
echo "<tr><td style='text-align:center;'><h2><a href='ofc_register.php'>New to TEC</a></h2></td></tr>";
